...
void buscaCaminhoIncidencia(); // função principal que utiliza a matriz de Incidência
...
void buscaCaminhoAdjacencia(); // função principal que utiliza a matria de Adjacência
...
void buscaCaminhoAdjacencia(){
 ...
 int proximoVertice, i;
    ...
    proximoVertice = buscaMenorValorAdjacencia(0); //busca o próximo vértice a partir do vértice 0
...
int buscaMenorValorAdjacencia(int linha){
    ...
    //busca o próximo vértice até todos serem visitados
